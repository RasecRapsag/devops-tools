...
variable "template_description" {
    ...
    type        = string
    default     = "Alpine Linux 3, generated on {{ isotime \"2006-01-02T15:04:05Z\" }}"
}
...
variable "template_iso_file" {
    ...
    type        = string
    default     = null      # alpine-virt-3.18.2-x86_64.iso
}

variable "template_iso_url" {
    description = "Iso file to upload to Proxmox"
    type        = string
    default     = "https://dl-cdn.alpinelinux.org/alpine/v3.18/releases/x86_64/alpine-virt-3.18.2-x86_64.iso"
}

variable "template_iso_checksum" {
    description = "Checksum of the iso file for validation"
    type        = string
    default     = "6bc7ff54f5249bfb67082e1cf261aaa6f307d05f64089d3909e18b2b0481467f"
}
...
variable "keyboard_layout" {
    description = "Sets the keyboard layout during alpine install"
    type        = string
    default     = "us"
}

variable "keyboard_variant" {
    description = "Sets the keyboard variant during alpine install"
    type        = string
    default     = "us"
}

variable "hostname" {
    description = "Sets the hostname during alpine install"
    type        = string
    default     = "alpine3"
}

variable "timezone" {
    description = "Sets the timezone during alpine install"
    type        = string
    default     = "America/Sao_Paulo"
}

variable "dns_servers" {
    description = "Sets the DNS servers during alpine install"
    type        = list(string)
    default     = []

    validation {
        condition     = var.dns_servers != null
        error_message = "Dns servers list must not be null. Empty list is allowed."
    }
}
